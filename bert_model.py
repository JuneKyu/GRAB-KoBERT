...
def fine_tune_and_test(train_data, val_data, test_data, num_labels, num_epochs,
                       batch_size):
    ...
    for epoch_i in range(0, epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            if step % 40 == 0 and not step == 0:
                ...
                log.info("batch {:>5,} of {:>5}. Elapsed: {:}.".format(
                    step, len(train_dataloader), elapsed))
            ...
            scheduler.step(
            )  # update the learning rate (in transformer architecture)
        ...
        log.info("  Training epcoh took: {:}".format(
        ...
        log.info("  Validation took: {:}".format(format_time(time.time() -
                                                             t0)))
